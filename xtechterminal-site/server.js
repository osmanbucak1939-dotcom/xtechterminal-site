// XTechTerminal tanıtım sitesi — basit lead toplama + admin paneli
...
function requireAuth(req, res, next) {
  ...
  res.set('WWW-Authenticate', 'Basic realm="XTechTerminal Admin"');
...
<title>XTechTerminal Admin — Başvurular</title>
<style>
...
<body>
  ...
  <h1>XTechTerminal — Demo Başvuruları</h1>
...
app.listen(PORT, () => {
  console.log(`XTechTerminal tanıtım sitesi ${PORT} portunda çalışıyor.`);
